...
## Issues
> ### Issue 1: _After trying to format the Jenkins file, we run into a error that I havent seen before and couldnt intuitivly get a idea of what the message meant. `WorkflowScript: 7: expecting ''', found '\r' @ line 7, column 21. #!/bin/bash`_
